...
public:
    ...
    CertifyCreation_Out certify_creation(TSS_CONTEXT* ctx, TPM_HANDLE& signing_key, TPM_HANDLE& certifiable_key, TPM2B_DIGEST& creation_hash, TPMT_TK_CREATION& creation_ticket, TPM_HANDLE* sessionHandle, const char* pass);
