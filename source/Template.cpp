...
/**
 * Creates a Primary template for storage using ECC
 *
 * @param policyDigest is a policy digest to use, can be null.
 *
 */
...
/**
 * Creates an ECC Signing key template
 *
 * @param policyDigest is a policy digest to use, can be null.
 *
 */
...
/**
 * Creates an unrestricted ECC Signing key template
 *
 * @param policyDigest is a policy digest to use, can be null.
 *
 */
